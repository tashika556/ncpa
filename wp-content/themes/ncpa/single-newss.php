...
<section class="news_detail pt-0 position-relative">
   <div class="container">
      <div class="row">
         <div class="col-lg-10 mx-auto">
            <div class="section_title  padding_y bg_gray">
               <h6><strong><i class="fa fa-calendar-minus-o" aria-hidden="true"></i> </strong><?php echo get_the_date(); ?></h6>
               <h2><?php the_title(); ?>
               </h2>
